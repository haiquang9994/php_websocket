            ...
            742: (t, e) => {
                ...
                (e.byteLength = function (t) {
                    ...
                    (e.toByteArray = function (t) {
                        ...
                        return (
                            2 === s &&
                                ((e = (n[t.charCodeAt(r)] << 2) | (n[t.charCodeAt(r + 1)] >> 4)), (h[a++] = 255 & e)),
                            1 === s &&
                                ((e =
                                    (n[t.charCodeAt(r)] << 10) |
                    ...
                    (e.fromByteArray = function (t) {
                        for (var e, n = t.length, o = n % 3, i = [], f = 16383, s = 0, u = n - o; s < u; s += f)
                ...
                function h(t, e, n) {
                    for (var o, i, f = [], s = e; s < n; s += 3)
                        (o = ((t[s] << 16) & 16711680) + ((t[s + 1] << 8) & 65280) + (255 & t[s + 2])),
                            f.push(r[((i = o) >> 18) & 63] + r[(i >> 12) & 63] + r[(i >> 6) & 63] + r[63 & i]);
                    return f.join("");
                }
            ...
            764: (t, e, r) => {
                    ...
                    return X(
                        (function (t, e) {
                            ...
                            for (let f = 0; f < t.length && !((e -= 2) < 0); ++f)
                                (r = t.charCodeAt(f)), (n = r >> 8), (o = r % 256), i.push(o), i.push(n);
                            return i;
                        })(e, t.length - r),
                        t,
                        r,
                ...
                (e.kMaxLength = f),
                    ...
                    (u.prototype.compare = function (t, e, r, n, o) {
                        if ((J(t, Uint8Array) && (t = u.from(t, t.offset, t.byteLength)), !u.isBuffer(t)))
                            throw new TypeError(
                ...
                (u.prototype.slice = function (t, e) {
                    ...
                    (u.prototype.readInt8 = function (t, e) {
                        return (
                            (t >>>= 0), e || x(t, 1, this.length), 128 & this[t] ? -1 * (255 - this[t] + 1) : this[t]
                        );
                    }),
                        ...
                        function (t, e, r) {
                            ...
                            return (
                                Number.isInteger(r) && Math.abs(r) > 2 ** 32
                                    ...
                                    : "bigint" == typeof r &&
                                      ((o = String(r)),
                                      (r > BigInt(2) ** BigInt(32) || r < -(BigInt(2) ** BigInt(32))) && (o = D(o)),
                                      (o += "n")),
                            ...
                            e = Math.abs(e),
                                isNaN(e) || e === 1 / 0
                                    ...
                                    : ((f = Math.floor(Math.log(e) / Math.LN2)),
                                      ...
                                      (e += f + c >= 1 ? p / u : p * Math.pow(2, 1 - c)) * u >= 2 && (f++, (u /= 2)),
                                      f + c >= a
                                          ? ((s = 0), (f = a))
                                          : f + c >= 1
...
(() => {
    function WSClient(url, binary = false) {
        ...
        function __message(message) {
            if (binary) {
                const binary_string = Buffer.from(message).toString("binary");
